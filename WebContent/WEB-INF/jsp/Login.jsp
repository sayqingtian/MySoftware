...
<script>
(function(){
    var sub = document.getElementById("register-submit");
    //初始化移入移出事件
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="login_validate" method="post" role="form" style="display: block;">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="forgetPwd" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
